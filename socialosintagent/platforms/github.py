import logging, os, random, re, httpx
...
class GitHubFetcher(BaseFetcher):
    ...
    def _normalize(
        self, ev: Any, profile: NormalizedProfile, **kwargs
    ) -> NormalizedPost:
    ...
    def _is_interesting_commit(self, event: Dict) -> bool:
        ...
        for commit in commits:
            ...
            if len(msg) > 200 or any(
                kw in msg for kw in ["security", "cve", "auth", "crypto"]
            ):
                return True
    ...
    def _analyze_patch(
        self, event: Dict, client: httpx.Client
        ...
        try:
            ...
            return {
                ...
                "security_related": any(
                    kw in patch.lower()
                    for kw in ["security", "auth", "crypto", "password"]
                ),
            }
...
def fetch_data(**kwargs):
    return GitHubFetcher().fetch_data(
